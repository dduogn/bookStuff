...
The function lets you input author, title information as well as categorized them based on whether the book is finished, reading, or to be read. It also has the option export the list as a csv named books.csv or you can also import your own list instead of starting a new one. I provided a sample list within the data folder to try.
